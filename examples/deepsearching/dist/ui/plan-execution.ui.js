...
const plan_parser_1 = require("../planning/plan-parser");
...
function parsePlanStream(content) {
    ...
    if (graphMatch && graphMatch[1]) {
        graph = (0, plan_parser_1.parseExecutionGraph)(graphMatch[1]);
        if (!graph) {
...
function renderWorkflowGraph(ctx, graph, taskStatuses, taskToolCounts) {
    ...
    let sortedTasks;
    try {
        sortedTasks = (0, plan_parser_1.topologicalSort)(graph);
    }
    catch (e) {
