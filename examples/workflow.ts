...
const WorkflowIntegration = (function () {
   ...
   * @returns 工作流列表
   */
  async function get_all_workflows(): Promise<any> {
   ...
   * @returns 创建结果
   */
  async function create_workflow(params: Workflow.CreateParams): Promise<any> {
    const data = await Tools.Workflow.create(
      params.name,
      params.description || "",
      params.nodes || null,
   ...
   * @returns 工作流详情
   */
  async function get_workflow(params: Workflow.GetParams): Promise<any> {
   ...
   * @returns 更新结果
   */
  async function update_workflow(params: Workflow.UpdateParams): Promise<any> {
   ...
   * @returns 更新结果
   */
  async function patch_workflow(params: Workflow.PatchParams): Promise<any> {
   ...
   * @returns 删除结果
   */
  async function delete_workflow(params: Workflow.DeleteParams): Promise<any> {
   ...
   * @returns 执行结果
   */
  async function trigger_workflow(params: Workflow.TriggerParams): Promise<any> {
   ...
   * @param params 函数参数
   */
  async function wrapToolExecution<P>(func: (params: P) => Promise<any>, params: P): Promise<void> {
    try {
  ...
  return {
    ...
    create_workflow: (params: Workflow.CreateParams) => wrapToolExecution(create_workflow, params),
